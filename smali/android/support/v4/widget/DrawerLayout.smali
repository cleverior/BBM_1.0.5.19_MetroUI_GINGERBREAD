...
.field private final f:Landroid/support/v4/widget/al;

.field private final g:Landroid/support/v4/widget/al;

.field private final h:Landroid/support/v4/widget/m;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/m;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/m;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/m;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/m;->a(Landroid/support/v4/widget/al;)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/m;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/al;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ao;)Landroid/support/v4/widget/al;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/al;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/al;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/al;->a(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/m;->a(Landroid/support/v4/widget/al;)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/cd;->a(Landroid/view/ViewGroup;Z)V
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/al;->a()I

    move-result v2

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/al;

    invoke-virtual {v3}, Landroid/support/v4/widget/al;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/j;
...
.method a(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;
    ...
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/al;
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/m;
...
.method b(Landroid/view/View;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/widget/k;->d:Z
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;

    invoke-virtual {v0, v4}, Landroid/support/v4/widget/al;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/al;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/al;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/al;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/al;->b()I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v4/widget/k;-><init>(II)V
...
.method public h(Landroid/view/View;)V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/al;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/al;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->g:Landroid/support/v4/widget/al;
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/al;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/al;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    iget v8, v0, Landroid/support/v4/widget/k;->rightMargin:I
    ...
    iget v8, v0, Landroid/support/v4/widget/k;->topMargin:I
    ...
    iget v8, v0, Landroid/support/v4/widget/k;->width:I
    ...
    iget v9, v0, Landroid/support/v4/widget/k;->bottomMargin:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->f:Landroid/support/v4/widget/al;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/al;->d(II)Landroid/view/View;
...
.method public setDrawerListener(Landroid/support/v4/widget/j;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->q:Landroid/support/v4/widget/j;
