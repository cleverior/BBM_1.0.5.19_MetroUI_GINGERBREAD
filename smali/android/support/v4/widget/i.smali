...
.method constructor <init>(Landroid/support/v4/widget/DrawerLayout;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/i;->b:Landroid/support/v4/widget/DrawerLayout;
...
.method private a(Landroid/support/v4/view/a/a;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/i;->b(Landroid/view/View;)Z
    ...
    :cond_1
    invoke-static {v0}, Landroid/support/v4/view/bi;->c(Landroid/view/View;)I
    ...
    invoke-static {v0, v3}, Landroid/support/v4/view/bi;->b(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v4/widget/i;->a(Landroid/support/v4/view/a/a;Landroid/view/ViewGroup;)V
...
.method public a(Landroid/view/View;Landroid/support/v4/view/a/a;)V
    ...
    invoke-static {p1}, Landroid/support/v4/view/bi;->f(Landroid/view/View;)Landroid/view/ViewParent;
    ...
    :cond_0
    invoke-direct {p0, p2, v1}, Landroid/support/v4/widget/i;->a(Landroid/support/v4/view/a/a;Landroid/support/v4/view/a/a;)V

    invoke-virtual {v1}, Landroid/support/v4/view/a/a;->t()V

    check-cast p1, Landroid/view/ViewGroup;

    invoke-direct {p0, p2, p1}, Landroid/support/v4/widget/i;->a(Landroid/support/v4/view/a/a;Landroid/view/ViewGroup;)V
...
.method public a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/i;->b(Landroid/view/View;)Z
...
.method public b(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/i;->b:Landroid/support/v4/widget/DrawerLayout;
