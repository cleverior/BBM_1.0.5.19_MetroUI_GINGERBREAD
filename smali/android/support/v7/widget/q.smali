...
.method static constructor <clinit>()V
    ...
    sget-object v0, Landroid/support/v7/widget/q;->c:Landroid/support/v7/widget/p;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v7/widget/q;-><init>(Landroid/support/v7/widget/t;Landroid/support/v7/widget/t;)V

    return-void
.end method

.method private constructor <init>(IIIIIILandroid/support/v7/widget/t;Landroid/support/v7/widget/t;)V
    .locals 1
    ...
    invoke-virtual {p0, p3, p4, p5, p6}, Landroid/support/v7/widget/q;->setMargins(IIII)V

    iput-object p7, p0, Landroid/support/v7/widget/q;->a:Landroid/support/v7/widget/t;

    iput-object p8, p0, Landroid/support/v7/widget/q;->b:Landroid/support/v7/widget/t;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/q;->a(Landroid/content/Context;Landroid/util/AttributeSet;)V

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/q;->b(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-void
.end method

.method public constructor <init>(Landroid/support/v7/widget/t;Landroid/support/v7/widget/t;)V
    .locals 9
    ...
    invoke-direct/range {v0 .. v8}, Landroid/support/v7/widget/q;-><init>(IIIIIILandroid/support/v7/widget/t;Landroid/support/v7/widget/t;)V
...
.method private a(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/v7/c/c;->GridLayout_Layout:[I
