...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0, v2, v3}, Landroid/support/v7/widget/m;-><init>(Landroid/support/v7/widget/GridLayout;ZLandroid/support/v7/widget/a;)V

    iput-object v0, p0, Landroid/support/v7/widget/GridLayout;->c:Landroid/support/v7/widget/m;

    new-instance v0, Landroid/support/v7/widget/m;

    invoke-direct {v0, p0, v1, v3}, Landroid/support/v7/widget/m;-><init>(Landroid/support/v7/widget/GridLayout;ZLandroid/support/v7/widget/a;)V
    ...
    sget v1, Landroid/support/v7/c/b;->default_gap:I
    ...
    sget-object v0, Landroid/support/v7/c/c;->GridLayout:[I
...
.method private static a(Landroid/support/v7/widget/p;ZI)I
    .locals 2

    invoke-virtual {p0}, Landroid/support/v7/widget/p;->a()I
...
.method private a(Landroid/view/View;Landroid/support/v7/widget/q;ZZ)I
    .locals 5
    ...
    iget-object v0, p2, Landroid/support/v7/widget/q;->b:Landroid/support/v7/widget/t;
    ...
    :goto_2
    iget-object v4, v3, Landroid/support/v7/widget/t;->c:Landroid/support/v7/widget/p;
    ...
    iget v0, v4, Landroid/support/v7/widget/p;->a:I
    ...
    :cond_1
    iget-object v0, p2, Landroid/support/v7/widget/q;->a:Landroid/support/v7/widget/t;
...
.method public static a(I)Landroid/support/v7/widget/t;
    .locals 1

    const/4 v0, 0x1

    invoke-static {p0, v0}, Landroid/support/v7/widget/GridLayout;->b(II)Landroid/support/v7/widget/t;
...
.method public static a(IILandroid/support/v7/widget/j;)Landroid/support/v7/widget/t;
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/t;-><init>(ZIILandroid/support/v7/widget/j;Landroid/support/v7/widget/a;)V
...
.method private a(IIZ)V
    ...
    :cond_1
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/GridLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/q;

    move-result-object v3

    if-eqz p3, :cond_2

    iget v4, v3, Landroid/support/v7/widget/q;->width:I

    iget v5, v3, Landroid/support/v7/widget/q;->height:I
    ...
    iget-object v0, v3, Landroid/support/v7/widget/q;->b:Landroid/support/v7/widget/t;

    :goto_3
    iget-object v4, v0, Landroid/support/v7/widget/t;->d:Landroid/support/v7/widget/j;

    sget-object v5, Landroid/support/v7/widget/GridLayout;->t:Landroid/support/v7/widget/j;

    if-ne v4, v5, :cond_0

    iget-object v4, v0, Landroid/support/v7/widget/t;->c:Landroid/support/v7/widget/p;
    ...
    :cond_4
    iget-object v0, v3, Landroid/support/v7/widget/q;->a:Landroid/support/v7/widget/t;
    ...
    :cond_6
    iget v9, v3, Landroid/support/v7/widget/q;->width:I
...
.method public static b(II)Landroid/support/v7/widget/t;
    .locals 1

    sget-object v0, Landroid/support/v7/widget/GridLayout;->k:Landroid/support/v7/widget/j;

    invoke-static {p0, p1, v0}, Landroid/support/v7/widget/GridLayout;->a(IILandroid/support/v7/widget/j;)Landroid/support/v7/widget/t;
...
.method private b()Z
    ...
    invoke-static {p0}, Landroid/support/v4/view/bi;->e(Landroid/view/View;)I
...
.method private c(Landroid/view/View;ZZ)I
    ...
    :goto_2
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/GridLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/q;
...
.method private c()V
    ...
    iget-object v3, v0, Landroid/support/v7/widget/q;->a:Landroid/support/v7/widget/t;

    :goto_4
    iget-object v10, v3, Landroid/support/v7/widget/t;->c:Landroid/support/v7/widget/p;

    iget-boolean v11, v3, Landroid/support/v7/widget/t;->b:Z

    invoke-virtual {v10}, Landroid/support/v7/widget/p;->a()I

    move-result v12

    if-eqz v11, :cond_0

    iget v4, v10, Landroid/support/v7/widget/p;->a:I

    :cond_0
    if-eqz v7, :cond_6

    iget-object v3, v0, Landroid/support/v7/widget/q;->b:Landroid/support/v7/widget/t;

    :goto_5
    iget-object v10, v3, Landroid/support/v7/widget/t;->c:Landroid/support/v7/widget/p;

    iget-boolean v13, v3, Landroid/support/v7/widget/t;->b:Z

    invoke-static {v10, v13, v1}, Landroid/support/v7/widget/GridLayout;->a(Landroid/support/v7/widget/p;ZI)I

    move-result v14

    if-eqz v13, :cond_d

    iget v3, v10, Landroid/support/v7/widget/p;->a:I
    ...
    invoke-static {v0, v4, v12, v3, v14}, Landroid/support/v7/widget/GridLayout;->a(Landroid/support/v7/widget/q;IIII)V
    ...
    :cond_b
    invoke-static {v0, v3, v14, v4, v12}, Landroid/support/v7/widget/GridLayout;->a(Landroid/support/v7/widget/q;IIII)V
...
.method private e()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->h()V
...
.method a(Landroid/view/View;ZZ)I
    ...
    iget v0, v1, Landroid/support/v7/widget/q;->leftMargin:I
    ...
    invoke-direct {p0, p1, v1, p2, p3}, Landroid/support/v7/widget/GridLayout;->a(Landroid/view/View;Landroid/support/v7/widget/q;ZZ)I
    ...
    :cond_1
    iget v0, v1, Landroid/support/v7/widget/q;->rightMargin:I
    ...
    iget v0, v1, Landroid/support/v7/widget/q;->topMargin:I

    goto :goto_0

    :cond_3
    iget v0, v1, Landroid/support/v7/widget/q;->bottomMargin:I

    goto :goto_0
.end method

.method final a(Landroid/support/v7/widget/j;Z)Landroid/support/v7/widget/j;
    .locals 1
    ...
    sget-object p1, Landroid/support/v7/widget/GridLayout;->n:Landroid/support/v7/widget/j;

    goto :goto_0

    :cond_1
    sget-object p1, Landroid/support/v7/widget/GridLayout;->s:Landroid/support/v7/widget/j;

    goto :goto_0
.end method

.method protected a()Landroid/support/v7/widget/q;
    .locals 1
...
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/q;
    .locals 2
...
.method final a(Landroid/view/View;)Landroid/support/v7/widget/q;
    .locals 1
...
.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/q;
    .locals 1
...
.method protected synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/GridLayout;->a()Landroid/support/v7/widget/q;
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/GridLayout;->a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/q;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/GridLayout;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/q;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/m;->f()[I
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/GridLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/q;
    ...
    invoke-virtual {v0, v2, v4}, Landroid/support/v7/widget/GridLayout;->a(Landroid/support/v7/widget/j;Z)Landroid/support/v7/widget/j;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/GridLayout;->a(Landroid/support/v7/widget/j;Z)Landroid/support/v7/widget/j;
    ...
    invoke-virtual {v4, v3, v0, v5}, Landroid/support/v7/widget/j;->b(Landroid/view/View;II)I
    ...
    invoke-virtual {v8, v3, v0, v5}, Landroid/support/v7/widget/j;->b(Landroid/view/View;II)I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1, p1, v6}, Landroid/support/v4/view/bi;->a(III)I

    move-result v1

    invoke-static {v0, p2, v6}, Landroid/support/v4/view/bi;->a(III)I
