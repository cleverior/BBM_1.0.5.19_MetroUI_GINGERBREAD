...
.method public a()Z
    ...
    new-instance v2, Landroid/support/v7/internal/widget/af;
    ...
    invoke-direct {v2, v3, v4, v5}, Landroid/support/v7/internal/widget/af;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v2, p0, Landroid/support/v7/internal/view/menu/ad;->e:Landroid/support/v7/internal/widget/af;

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/ad;->e:Landroid/support/v7/internal/widget/af;

    invoke-virtual {v2, p0}, Landroid/support/v7/internal/widget/af;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/ad;->e:Landroid/support/v7/internal/widget/af;

    invoke-virtual {v2, p0}, Landroid/support/v7/internal/widget/af;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/internal/widget/af;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/ad;->e:Landroid/support/v7/internal/widget/af;

    invoke-virtual {v2, v1}, Landroid/support/v7/internal/widget/af;->a(Z)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ad;->e:Landroid/support/v7/internal/widget/af;

    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/af;->a(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/af;->e(I)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/ad;->e:Landroid/support/v7/internal/widget/af;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/af;->f(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/af;->h()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/internal/view/menu/ad;->e:Landroid/support/v7/internal/widget/af;
