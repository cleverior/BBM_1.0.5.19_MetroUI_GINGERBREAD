...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/q;)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/j;->a:Landroid/support/v7/internal/view/menu/q;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/j;->b:Landroid/support/v7/internal/view/menu/u;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/j;->a:Landroid/support/v7/internal/view/menu/q;

    iget-object v1, p0, Landroid/support/v7/internal/widget/j;->b:Landroid/support/v7/internal/view/menu/u;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/q;->d(Landroid/support/v7/internal/view/menu/u;)Z

    :cond_0
    iput-object p2, p0, Landroid/support/v7/internal/widget/j;->a:Landroid/support/v7/internal/view/menu/q;
...
.method public a(Landroid/support/v7/internal/view/menu/q;Landroid/support/v7/internal/view/menu/u;)Z
    ...
    iput-object p2, p0, Landroid/support/v7/internal/widget/j;->b:Landroid/support/v7/internal/view/menu/u;
    ...
    invoke-static {v0}, Landroid/support/v7/internal/widget/ActionBarView;->i(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/av;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/internal/widget/av;->setVisibility(I)V
...
.method public b(Landroid/support/v7/internal/view/menu/q;Landroid/support/v7/internal/view/menu/u;)Z
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/av;->setVisibility(I)V
    ...
    iput-object v3, p0, Landroid/support/v7/internal/widget/j;->b:Landroid/support/v7/internal/view/menu/u;
...
.method public d(Z)V
    ...
    iget-object v4, p0, Landroid/support/v7/internal/widget/j;->b:Landroid/support/v7/internal/view/menu/u;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/internal/widget/j;->b(Landroid/support/v7/internal/view/menu/q;Landroid/support/v7/internal/view/menu/u;)Z
