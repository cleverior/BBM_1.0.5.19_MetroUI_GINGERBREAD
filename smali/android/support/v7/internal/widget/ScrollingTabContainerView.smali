...
.method private a(Landroid/support/v7/a/e;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
    .locals 5
    ...
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/a/e;Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d:Landroid/support/v7/internal/widget/au;

    if-nez v1, :cond_1

    new-instance v1, Landroid/support/v7/internal/widget/au;

    invoke-direct {v1, p0, v4}, Landroid/support/v7/internal/widget/au;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/internal/widget/as;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d:Landroid/support/v7/internal/widget/au;
...
.method static synthetic a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/a/e;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
    .locals 1

    invoke-direct {p0, p1, p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->a(Landroid/support/v7/a/e;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
...
.method private a()Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/support/v7/internal/widget/av;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/support/v7/internal/widget/av;

    invoke-virtual {v0}, Landroid/support/v7/internal/widget/av;->getParent()Landroid/view/ViewParent;
...
.method private b()V
    ...
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d()Landroid/support/v7/internal/widget/av;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/support/v7/internal/widget/av;
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/av;->d()Landroid/widget/SpinnerAdapter;
    ...
    invoke-direct {v1, p0, v4}, Landroid/support/v7/internal/widget/at;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/internal/widget/as;)V

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/av;->a(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/av;->a(I)V
...
.method private d()Landroid/support/v7/internal/widget/av;
    .locals 4
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/support/v7/internal/widget/av;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/av;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v0, p0}, Landroid/support/v7/internal/widget/av;->b(Landroid/support/v7/internal/widget/aa;)V
...
.method public a(I)V
    ...
    invoke-direct {v1, p0, v0}, Landroid/support/v7/internal/widget/as;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/view/View;)V
...
.method public a(Landroid/support/v7/internal/widget/x;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->getTab()Landroid/support/v7/a/e;
...
.method public setTabSelected(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/av;->a(I)V
