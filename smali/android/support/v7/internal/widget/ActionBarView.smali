...
.field private P:Landroid/support/v7/a/d;

.field private Q:Ljava/lang/Runnable;

.field private R:Landroid/support/v7/internal/widget/j;

.field private final S:Landroid/support/v7/internal/widget/ac;
...
.field private v:Landroid/support/v7/internal/widget/av;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->S:Landroid/support/v7/internal/widget/ac;
...
.method static synthetic a(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/a/d;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->P:Landroid/support/v7/a/d;
...
.method private a(Landroid/support/v7/internal/view/menu/q;)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/j;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/internal/view/menu/ActionMenuPresenter;->d(Z)V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/j;

    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/j;->d(Z)V
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/internal/widget/j;->a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/q;)V
...
.method static synthetic i(Landroid/support/v7/internal/widget/ActionBarView;)Landroid/support/v7/internal/widget/av;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->v:Landroid/support/v7/internal/widget/av;
...
.method public j()Z
    ...
    iget-object v0, v0, Landroid/support/v7/internal/widget/j;->b:Landroid/support/v7/internal/view/menu/u;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/internal/widget/ActionBarView;->f()V
...
.method public setCallback(Landroid/support/v7/a/d;)V
    ...
    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarView;->P:Landroid/support/v7/a/d;
...
.method public setDropdownAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/av;->a(Landroid/widget/SpinnerAdapter;)V
...
.method public setMenu(Landroid/support/v4/a/a/a;Landroid/support/v7/internal/view/menu/ag;)V
    .locals 5
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/j;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->R:Landroid/support/v7/internal/widget/j;
...
.method public setNavigationMode(I)V
    ...
    invoke-direct {v0, v1, v3, v2}, Landroid/support/v7/internal/widget/av;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarView;->v:Landroid/support/v7/internal/widget/av;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/ActionBarView;->v:Landroid/support/v7/internal/widget/av;
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarView;->S:Landroid/support/v7/internal/widget/ac;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/av;->a(Landroid/support/v7/internal/widget/ac;)V
